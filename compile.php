...
if(isset($_POST['text_box'])) {
    ...
    if($setcompiler==0){
	    exec('gcc '. $filename . $optstring . ' -o tmp/program 2>&1', $outputErr, $return_value);
    }
	else{
	    exec('i586-mingw32msvc-gcc ' . $filename . $optstring . ' -o tmp/program.exe 2>&1', $outputErr, $return_value);
	}
